...
os.system('clear')
print('''
\033[91m ____  ____   ____  __ __   ____  ______    ___ 
\033[91m|    \|    \ |    ||  |  | /    ||      |  /  _] ADMIN FINDER TOOLS V1.0
\033[91m|  o  )  D  ) |  | |  |  ||  o  ||      | /  [_ 
\033[91m|   _/|    /  |  | |  |  ||     ||_|  |_||    _] ARE YOU FUCKING
\033[97m|  |  |    \  |  | |  :  ||  _  |  |  |  |   [_ 
\033[97m|  |  |  .  \ |  |  \   / |  |  |  |  |  |     | GOD JOB !!
\033[97m|__|  |__|\_||____|  \_/  |__|__|  |__|  |_____|

''')

print('\033[91m Pakai Http / Https')
print('\033[91m Contoh : http://example.com/ ')
print('')
url = input("\033[97m MASUKIN TARGET : ")

print('')
print('')
print ("\033[97m M U L A I : ")
print("                                                                                        ")

jancok = ('adminweb/','redaktur/','admin/','administrator/','login.php','administration/','admin1/','admin2/','admin3/','admin4/','admin5/','moderator/','webadmin/','adminarea/','bb-admin/','adminLogin/','admin_area/','panel-administracion/','instadmin/',
...
for hani in jancok :
    ...
    try :
        ...
        print("\033[92m K E T E M U >>> "+curl)
    except urllib.error.URLError as msg :
        print ("\033[91m G A K E T E M U >>> "+curl)


print ("Done Yak Bangcat")
